 ...
 */
public class DocumentGalleryAdapter extends RecyclerView.Adapter<DocumentGalleryAdapter.ViewHolder>{
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            item_document = (ImageView) itemView.findViewById(R.id.item_document);
            sync_button = (Button) itemView.findViewById(R.id.item_document_sync);
            description_button = (Button) itemView.findViewById(R.id.item_document_description);
            delete_button = (Button) itemView.findViewById(R.id.item_document_delete);
        }
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.item_document.setImageBitmap(item.getPhoto_bitmap());
        ...
        holder.sync_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DocumentGalleryFragment.showQuestion(decodeGallery);
            }
        });
